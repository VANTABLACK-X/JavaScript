...
// 3. using bracket notation, add property('delivery time') with value('3 days'), chang the product name to lowe case, repeat a string and display it.
const product2 = {
    name: 'BasketBall',
    price: 2096,
